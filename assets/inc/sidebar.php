              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->pass_uname;?>'s Profile</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-profile.php">View Profile</a>
                      </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Book Ticket for commodities</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-book-train.php">Reserve Ticket for commodity</a>
                      </li>
                      <li><a href="pass-cancel-train.php">Cancel ticket</a>
                      </li>
