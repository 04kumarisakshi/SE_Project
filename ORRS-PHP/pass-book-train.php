                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    <thead class="thead-dark">
                      <tr>
                        ...
                        <th>Arrival</th>
                        <th>Dep.Time</th>
                        <th>Food Item (Fare)</th>
                        <th>Action</th>
                        <th>Finish Item (Fare)</th>
                        <th>Action</th>
                         <th>Raw Material (Fare)</th>
                        <th>Action</th>
                         <th>Electronic Item (Fare)</th>
                        <th>Action</th>
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">$<?php echo $row->Food_Items;?></td>
                        <td class="center">
                        <a href="pass-book-specific-train.php?id=<?php echo $row->id?>">
                        <button class="btn btn-success btn-sm">Book</button></a>
                        <td class="center">$<?php echo $row->finish;?></td>
                        <td class="center">
                        <a href="pass-book-specific-train.php?id=<?php echo $row->id?>">
                        <button class="btn btn-success btn-sm">Book</button></a>
                        <td class="center">$<?php echo $row->Raw_material;?></td>
                        <td class="center">
                        <a href="pass-book-specific-train.php?id=<?php echo $row->id?>">
                        <button class="btn btn-success btn-sm">Book</button></a>
                        <td class="center">$<?php echo $row->electronic;?></td>
                        <td class="center">
                        <a href="pass-book-specific-train.php?id=<?php echo $row->id?>">
                        <button class="btn btn-success btn-sm">Book</button></a>
                        </td>
