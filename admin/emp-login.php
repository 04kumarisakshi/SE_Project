        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/rail_logo.png" alt="logo" width="{conf.logoWidth}" height="88"><span class="splash-description">Admin Login Panel</span></div>
              <div class="card-body">
